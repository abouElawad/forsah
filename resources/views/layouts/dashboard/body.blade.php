												...
												<div class="card-body d-flex flex-column justify-content-end pe-0">
													...
													<div class="symbol-group symbol-hover flex-nowrap">
														...
														<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
															<img alt="Pic" src="{{asset('assets/dashboard/media/avatars/300-11.jpg')}}" />
														</div>
														<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
															<span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
														</div>
														<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
															<img alt="Pic" src="{{asset('assets/dashboard/media/avatars/300-2.jpg')}}" />
														</div>
														<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Perry Matthew">
															<span class="symbol-label bg-danger text-inverse-danger fw-bold">P</span>
														</div>
														<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
															<img alt="Pic" src="{{asset('assets/dashboard/media/avatars/300-12.jpg')}}" />
														</div>
															...
															<div class="table-responsive">
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/210.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/215.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/209.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
															...
															<div class="table-responsive">
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/197.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
																				<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-4312</span>
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/178.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/22.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															...
															<div class="table-responsive">
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/1.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/24.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/71.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															...
															<div class="table-responsive">
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/41.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/63.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/59.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																				<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															...
															<div class="table-responsive">
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/10.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/96.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
																		...
																		<tr>
																			<td>
																				<img src="{{asset('assets/dashboard/media/stock/ecommerce/13.png')}}" class="w-50px ms-n1" alt="" />
																			</td>
																			<td class="ps-0">
													...
													<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	<!--begin::Icon-->
																	<img src="{{asset('assets/dashboard/media/stock/ecommerce/210.png')}}" class="w-50px ms-n1 me-1" alt="" />
																	<!--end::Icon-->
																	<!--begin::Title-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	<!--begin::Icon-->
																	<img src="{{asset('assets/dashboard/media/stock/ecommerce/209.png')}}" class="w-50px ms-n1 me-1" alt="" />
																	<!--end::Icon-->
																	<!--begin::Title-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	<!--begin::Icon-->
																	<img src="{{asset('assets/dashboard/media/stock/ecommerce/214.png')}}" class="w-50px ms-n1 me-1" alt="" />
																	<!--end::Icon-->
																	<!--begin::Title-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	<!--begin::Icon-->
																	<img src="{{asset('assets/dashboard/media/stock/ecommerce/211.png')}}" class="w-50px ms-n1 me-1" alt="" />
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
																	<!--end::Title-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	<!--begin::Icon-->
																	<img src="{{asset('assets/dashboard/media/stock/ecommerce/215.png')}}" class="w-50px ms-n1 me-1" alt="" />
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
																	<!--end::Title-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	<!--begin::Icon-->
																	<img src="{{asset('assets/dashboard/media/stock/ecommerce/192.png')}}" class="w-50px ms-n1 me-1" alt="" />
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
																	<!--end::Title-->
